                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-pink-200 bg-gray-100" src="https://firebasestorage.googleapis.com/v0/b/yj---fashion.appspot.com/o/OTHER%20IMAGE-3.jpg?alt=media&token=d180ec7c-c61a-460b-b3bb-693bd184d99d" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Rachit Makwana</h2>
                                <p className="text-gray-500">Customer</p>
                            </div>
                        </div>
                    </div>
