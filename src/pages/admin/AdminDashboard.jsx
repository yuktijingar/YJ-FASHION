                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        <div className="flex justify-center">
                            <img src="https://cdn-icons-png.flaticon.com/128/4842/4842439.png" alt="" />
                        </div>
                        {/* text  */}
                        <div className="">
                            {/* Name */}
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Name :</span> {user.name && user.name.charAt(0).toUpperCase() + user.name.substring(1).toLowerCase()}</h1>
                            {/* Email */}
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Email :</span> {user.email}</h1>
                            {/* Date */}
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Create Date :</span> {user.date}</h1>
                            {/* Role */}
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Role :</span> {user.role && user.role.charAt(0).toUpperCase() + user.role.substring(1).toLowerCase()}</h1>
                        </div>
                    </div>
                </div>
